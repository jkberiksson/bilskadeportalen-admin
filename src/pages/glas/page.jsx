...
export default function GlasPage() {
    ...
    useEffect(() => {
        const filtered = glassDamage.filter((claim) => {
            ...
            const matchesEndDate = !endDate || claimDate <= new Date(endDate.setHours(23, 59, 59, 999)); // Include the entire end date
    ...
    return (
        <div className='space-y-4'>
            ...
            <div className='flex items-center justify-between'>
                <h1 className='text-xl font-bold text-[var(--text-primary)]'>Glasskador</h1>
            </div>
